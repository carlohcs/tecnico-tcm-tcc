...
$(document).ready(function(){
	...
	login.css({'color':'#333333', 'font-style':'italic'});
	login.focus(function(){ login.css({'color':'#797575','font-style':'normal'}); if(($(this).val()) == "nome de usuário"){ $(this).val("");} });
	login.blur(function(){ if(($(this).val()) == "usuário"){ $(this).val(""); } if(($(this).val()) == ""){ $(this).val("nome de usuário"); login.css({'color':'#333333', 'font-style':'italic'});} });
	
	//Propriedades para o campo Senha
	senha.focus(function(){ if(($(this).val()) == "************"){ $(this).val("");} });
	senha.blur(function(){ if(($(this).val()) == "************"){ $(this).val(""); } if(($(this).val()) == ""){ $(this).val("************"); } });
	
	//Propriedades para o campo Buscar
	search.css({'color':'#333333', 'font-style':'italic'});
	search.focus(function(){ search.css({'color':'#797575','font-style':'normal'}); if(($(this).val()) == "palavra-chave..."){ $(this).val("");} });
	search.blur(function(){ if(($(this).val()) == "palavra-chave..."){ $(this).val(""); } if(($(this).val()) == ""){ $(this).val("palavra-chave..."); search.css({'color':'#333333', 'font-style':'italic'});} });
