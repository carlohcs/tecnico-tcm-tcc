...
$(document).ready(function(){
	...
	login.focus(function(){ login.css({'color':'#797575','font-style':'normal'}); if(($(this).val()) == "user name"){ $(this).val("");} });
	login.blur(function(){ if(($(this).val()) == "usuário"){ $(this).val(""); } if(($(this).val()) == ""){ $(this).val("user name"); login.css({'color':'#333333', 'font-style':'italic'});} });
	...
	search.focus(function(){ search.css({'color':'#797575','font-style':'normal'}); if(($(this).val()) == "keyword..."){ $(this).val("");} });
	search.blur(function(){ if(($(this).val()) == "keyword..."){ $(this).val(""); } if(($(this).val()) == ""){ $(this).val("keyword..."); search.css({'color':'#333333', 'font-style':'italic'});} });
