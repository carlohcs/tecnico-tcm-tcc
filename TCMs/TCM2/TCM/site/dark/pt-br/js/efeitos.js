...
$(document).ready(function(){
	...
	login.css({'color':'#626262', 'font-style':'italic'});
	login.focus(function(){ login.css({'color':'#626262','font-style':'normal'}); if(($(this).val()) == "nome de usuário"){ $(this).val("");} });
	login.blur(function(){ if(($(this).val()) == "usuário"){ $(this).val(""); } if(($(this).val()) == ""){ $(this).val("nome de usuário"); login.css({'color':'#626262', 'font-style':'italic'});} });
	
	//Propriedades para o campo Senha
	senha.focus(function(){ senha.css({'color':'#626262','font-style':'normal'}); if(($(this).val()) == "************"){ $(this).val("");} });
	senha.blur(function(){ if(($(this).val()) == "************"){ $(this).val(""); } if(($(this).val()) == ""){ $(this).val("************"); senha.css({'color':'#626262'});} });
	
	//Propriedades para o campo Buscar
	search.css({'color':'#626262', 'font-style':'italic'});
	search.focus(function(){ search.css({'color':'#626262','font-style':'normal'}); if(($(this).val()) == "palavra-chave..."){ $(this).val("");} });
	search.blur(function(){ if(($(this).val()) == "palavra-chave..."){ $(this).val(""); } if(($(this).val()) == ""){ $(this).val("palavra-chave..."); search.css({'color':'#626262', 'font-style':'italic'});} });
	...
	$('#backTop').click(function(){
		...
		//Sharer
	$('#stSharer').hover(function(){
		$(this).css('background','url(img/sharer/setaEsq.png)');
		$('#sharer').stop().show('slow');
		//.css('display','block').animate({left: '1150px'}, 100);
	});
	$('#stSharer').mouseout(function(){
		$(this).css('background','url(img/sharer/setaDir.png)');
		$('#sharer').stop().hide('slow');
		//animate({display: 'none', left: '1100px'}, 100).css('display','none')
	;});
