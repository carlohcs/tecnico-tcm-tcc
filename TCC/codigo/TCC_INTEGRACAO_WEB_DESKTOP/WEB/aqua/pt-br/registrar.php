			...
			<form id="frmRegister"  class="frmData" method="POST" action="./registrar">
				<fieldset>
					<dl>
						...
						<dd>Máximo de 50 caracteres</dd>
						
						<dt class="chkReg"><label for="chkEmail"><input type="checkbox" name="chkEmail"/><span>E-mail visível a outros usuários</span></label></dt>
						...
						<dt class="chkReg"><label for="chkDtNasc"><input type="checkbox" name="chkDtNasc"/><span>Data de Nascimento visível a outros usuários</span></label></dt>
