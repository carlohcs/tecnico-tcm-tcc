...
class manageEnquete extends sqlInstruction
{
	...
	function resultadoEnquete()
	{
		...
		$form.= "</ul>";
		$form.= "<form method='post'><input class='enqt2' type='submit' name='' value='Voltar' id='back' /></form><br />";
		echo $form;
	...
	function listaEnquete()
	{
		...
		$form.="<input class='enqt2' type='submit' name='frmResult' value='Resultado' id='result' /><br />";
		$form.="</form>";
		echo $form;
