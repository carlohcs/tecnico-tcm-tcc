	...
	<div id="center">
					...
					<div id="ini_box_center">	
						...
						<img src="<?php if($flaUsSess == true){ $ft = (trim($_SESSION['sessaoUsuario']['foto']) != "") ? $_SESSION['sessaoUsuario']['foto'] : 'img/login/user_default2.png'; echo $ft; }else{
						$ft = (trim($objSql->exibeArrayDados('foto','usuario')) != "") ? $objSql->exibeArrayDados('foto','usuario')  : 'img/login/user_default2.png'; echo $ft; }?>" width="114" height="112" id="user_img" alt="Usuário"/>
						...
						<div id="bg_username">
							<?php
								...
								echo "<li><a href='perfil/".$_SESSION['sessaoUsuario']['login']."'>{$objSql->exibeArrayDados('nome','usuario')} {$objSql->exibeArrayDados('sobrenome','usuario')}</a></li>";
								if($getUser == $_SESSION['sessaoUsuario']['login'] || $objSql->exibeArrayDados('flagEmail','usuario') == 1)
