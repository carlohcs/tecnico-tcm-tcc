...
.error{ background:#f0c6c3; border:1px solid #cc6622; }       
	...
	<div id="ft_grnd" style="float: left;">
		...
		<img src="<?php if(trim($_SESSION['sessaoUsuario']['foto']) != '') echo $_SESSION['sessaoUsuario']['foto']; else echo 'img/login/user_default2.png'; ?>" width="61" height="57" id="ftUserBox"/>
