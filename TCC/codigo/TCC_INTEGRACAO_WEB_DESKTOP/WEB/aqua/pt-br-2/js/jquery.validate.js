...
$.extend($.validator, {
	...
	messages: {
		...
		letters: "Apenas letras por favor.",
	...
	methods: {
		...
		email: function(value, element) {
			...
			return this.optional(element) || /^[a-z][\w\.-]*[a-zA-Z0-9]@[a-z0-9][\w\.-]*[a-z0-9]\.[a-z][a-z\.]*[a-z]$/.test(value);
		...
		dependSen: function(value, element) {
			if($('#senha').val() == $('#senhaConf').val()) return true; else return false;
		},
		dependSele: function(value, element) {
