...
$(document).ready(function(){
	...
	$('#l_left1 li').eq(3).click(function(e){
		...
		}else jAlert('<p>Faça login ou registre-se para escrever artigos.</p>', ' ', function(){$.alerts.dialogClass = null;});		
	});
	...
	$('.menu_usuario li:eq(3) a').click(function(e){
		...
		jAlert('<p>Você tem certeza que deseja excluir sua conta?</p>', ' ', function(){
			window.location.href = "http://127.0.0.1:8080/TCC/aqua/pt-br/excluir-conta";
		}, 'visible');
	});
	//--EXLUIR USUÁRIO 
