		...
		<div id="box_data_user">
				...
				<fieldset>
					<dl>
						...
						<dt><label for="nome">Nome (máximo de 10 caracteres)</label></dt>
						<dd><input type="text" name="nom_usu" size="60" maxlength="10" id="nome" value="<?php echo $objSql->exibeArrayDados('nome','usuario'); ?>" /></dd>
						
						<dt><label for="sobrenom">Sobrenome: (máximo de 20 caracteres)</label></dt>
						...
						<dt><label for="email">Email: (máximo de 25 caracteres)</label></dt>
						<dd><input type="text" name="email_usu" maxlength="25"  id="email" size="60" value="<?php echo $objSql->exibeArrayDados('email','usuario'); ?>" /></dd>
						
						<dt><label for="chkEmail">E-mail visível a outros usuários: </label><input type="checkbox" name="chkEmail" style="position:absolute;left:380px" <?php if($objSql->exibeArrayDados('flagEmail','usuario') == 1) echo "checked='cheked'"; ?>/></dt>
						
						<dt><label for="senha">Senha: (mínimo de 6 e máximo de 12 caracteres)</label></dt>
						...
						<dt><label for="dataNasc">Data de Nascimento: (dd/mm/aaaa)</label></dt>
						...
						<dt><label for="chkDtNasc">Data de Nascimento visível a outros usuários: </label><input type="checkbox" name="chkDtNasc" style="position:absolute;left:480px" <?php if($objSql->exibeArrayDados('flagEmail','usuario') == 1) echo "checked='cheked'"; ?>/></dt>
