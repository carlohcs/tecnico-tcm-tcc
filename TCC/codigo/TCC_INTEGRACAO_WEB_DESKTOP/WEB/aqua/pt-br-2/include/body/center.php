<!-- Banner notícias -->
			...
			<div id="bg_cbanner">
				...
				<?php 
					for($i=0;$i<4;$i++)
						echo "<li><a href='{$returnData['links'][$i]}'><img src='{$returnData['caminhoImg'][$i]}' alt='BannerPublicidade' /></a>
						<div class='fundo'><p><a href='{$returnData['links'][$i]}' title='Publicidade ".($i + 1)."'>{$returnData['descricao'][$i]}</a></p></div></li>";
				?>
				</ul>
			</div>
			...
			<div id="bg_main_article">
				...
				<a href="todos-destaques" class="featured">Todos os destaques</a>
			</div>
