...
class manageEnquete extends sqlInstruction
{
	...
	function resultadoEnquete()
	{
		...
		$form.= "</ul>";
		$form.= "<a class='enqt2' href='".$_GET['page']."/enquete/visualizar' id='back'>Voltar</a>";
		echo $form;
	...
	function listaEnquete()
	{
		...
		$form.= "<ul id='poll_frm'>";
		$form.= "<li><input type='radio' name='tpOp' value='0' class='styled' />".parent::exibeArrayDados("opcao1", "enquete")."</li>";
		$form.= "<li><input type='radio' name='tpOp' value='1' class='styled' />".parent::exibeArrayDados("opcao2", "enquete")."</li>";
		$form.= "<li><input type='radio' name='tpOp' value='2' class='styled' />".parent::exibeArrayDados("opcao3", "enquete")."</li>";
		$form.= "<li><input type='radio' name='tpOp' value='3' class='styled' />".parent::exibeArrayDados("opcao4", "enquete")."</li>";
		$form.= "</ul>";
